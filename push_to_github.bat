...
echo ========================================================
echo.
echo [1/3] Navigating to React application directory...
cd /d "%~dp0\health-tracker"
...
if %errorlevel% neq 0 (
    ...
    echo.
    echo Command format:
    echo git push https://YOUR_GITHUB_TOKEN@github.com/manaswini-2403/health-care-ai.git master
) else (
    echo.
